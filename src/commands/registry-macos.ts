/** macOS-specific closed vocabularies: app aliases, AppleScript key specs, Settings panes, Finder locations. */
...
export const KEY_SPECS: Record<string, MacKeySpec> = {
  ...
  "delete word": { keyCode: 51, modifiers: ["option down"] },
  ...
  "quick switcher": { character: "k", modifiers: ["command down"] },
};
...
/** Voice phrase -> Finder location path (relative to home, or absolute if it starts with "/"). */
